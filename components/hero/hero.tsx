...
const heroFrames = Array.from({ length: 60 }, (_, index) => {
  ...
  return `/images/frames/frame${frameNumber}.png`
})
...
export function Hero() {
  ...
  return (
    <section
      ref={heroRef}
      className="relative isolate min-h-[500svh] overflow-hidden bg-[var(--color-background)]"
    >
      <div className="sticky top-0 h-[100svh] overflow-hidden">
        ...
        <CanvasEngine frames={heroFrames} progress={progress} className="absolute inset-0" />
